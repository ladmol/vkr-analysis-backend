...
Подробный контракт для frontend описан в `docs/frontend-api-contract.md`.
Список разрешенных аналитических полей описан в `docs/analytics-fields.md`.
...
Integration tests используют локальную PostgreSQL-БД из `VKR-DB`.
Если БД недоступна, DB-зависимые тесты будут пропущены.